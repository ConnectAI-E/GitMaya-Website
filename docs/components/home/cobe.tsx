...
export const Logo = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 423 120" fill="none"
    ...
    return <div style={ {
        ...
        <div style={ {
            ...
            <div className={ 'flex justify-center items-center' }>
                <div className={'cursor-pointer px-12 flex justify-center items-center delay-100  group group-hover:opacity-45'}>
                    <YoutubeIcon className={' group-hover:text-red pt-0.5'} size={ 40 }></YoutubeIcon>
                    <span style={ { fontSize: '1.8em', paddingLeft: '10px' } }
                          className={ 'group-hover:opacity-80 ' }>Make Git Flow Again</span>
                </div>
