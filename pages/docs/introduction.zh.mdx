...
**Tailwind Variants** 一个一流 API 库 [TailwindCSS](https://tailwindcss.com/).

## 主要特点

#### 变体

自从 [Stitches](https://stitches.dev) 引入了变体以来，我们成为了它们的忠实粉丝。它们是创建一致性设计系统的绝佳方式，因此我们推出了 **Tailwind 变体** 来将它们引入 TailwindCSS。
...
要了解有关变体的更多信息，请查阅 [variants](/docs/variants) 页面。

#### 响应式变体

**Tailwind 变体** 允许您将变体应用于不同的屏幕尺寸。
