...
export function Cobe() {
  ...
  return <div style={ {
    ...
    <div style={ {
      ...
      <span style={ { fontSize: '1.8em' } }>Make Git Flow Again</span>
    </div>
    <canvas
      ref={ canvasRef }
      onPointerDown={ (e) => {
