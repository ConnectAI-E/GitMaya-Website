  ...
  footer: {
    text: (
      <div className="flex w-full flex-col items-center">
        ...
        <ul className="mt-6 flex cursor-pointer gap-4 text-gray-200">
          <li className="hover:text-white">Home</li>
          <li className="hover:text-white">Blog</li>
          <li className="hover:text-white">Doc</li>
          <li className="hover:text-white">Security</li>
          <li className="hover:text-white">Jobs</li>
        </ul>
        <ul className="mt-6 flex cursor-pointer gap-4 text-sm text-gray-400">
          <li className="hover:text-white">Graph Foundation</li>
          <li className="hover:text-white">Forum</li>
          <li className="hover:text-white">Testnet</li>
          <li className="hover:text-white">Partnership Requests</li>
